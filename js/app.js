(() => {
  ...
  function documentActions(e) {
    ...
    if (el.closest(".tabs-meal__button")) {
      ...
      const inputValue = 1;
      addToCart(productItem, productButton, inputValue);
    }
  ...
  function addToCart(itemId, productButton, inputValue) {
    if (!productButton.classList.contains("_hold")) {
      ...
      productImageFly.addEventListener("transitionend", () => {
        if (productButton.classList.contains("_fly")) {
          ...
          updateCart(itemId, productButton, inputValue);
